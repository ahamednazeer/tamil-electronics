...
class R3FErrorBoundary extends Component<{ children: ReactNode; fallback?: ReactNode }, { hasError: boolean }> {
...
export default function FluidGlass({
    ...
    return (
        <R3FErrorBoundary
            fallback={
                <div className='h-full w-full grid place-items-center text-[11px] text-muted/70'>
                    3D asset missing
                </div>
            }>
...
const ModeWrapper = memo(function ModeWrapper({
    ...
    return (
        <>
            {children ? createPortal(children, scene) : null}
