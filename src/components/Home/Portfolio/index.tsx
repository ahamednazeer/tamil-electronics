...
const Portfolio = () => {
  ...
  return (
    <section ref={sectionRef} className='py-10 sm:py-14 lg:py-16 min-h-0 overflow-hidden' id='products'>
      <div className='container px-4 sm:px-6'>
        ...
        >
          ...
          >
            <div
              ref={stripRef}
              className='flex items-stretch gap-5 sm:gap-7 lg:gap-10 will-change-transform'
            >
              {productsData.map((item, index) => (
                <div key={index} className='flex-none w-[340px] sm:w-[440px] lg:w-[540px]'>
