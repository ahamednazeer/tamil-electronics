...
export const brandsData: BrandData[] = [
  ...
  { 
    name: 'RR Kabel', 
    slug: 'rr-kabel', 
    logo: '/images/brands/rr-kabel.webp',
    seoTitle: 'RR Kabel Electrical Wires Shop in Virudhachalam | Tamil Electricals',
    seoDescription: 'Shop fire-resistant RR Kabel house wires and industrial cables at Tamil Electricals, your local Virudhachalam electrical distributor.',
  ...
  { 
    name: 'Suguna', 
    slug: 'suguna', 
    logo: '/images/brands/suguna.webp',
    seoTitle: 'Suguna Motors and Agricultural Water Pumps in Virudhachalam',
    seoDescription: 'High-performance Suguna water motors and borewell pumps for agriculture and domestic use at Tamil Electricals in Virudhachalam.',
    categories: ['Pumps']
  },
  { 
    name: 'CG', 
  ...
  { 
    name: 'Kundan', 
    slug: 'kundan', 
    logo: '/images/brands/kundan.webp',
    seoTitle: 'Kundan Cab & Wires Dealer in Virudhachalam',
    seoDescription: 'Buy Kundan cab quality electrical wires with guaranteed safety for home installations from Tamil Electricals in Virudhachalam.',
    categories: ['Wires & Cables']
  }
]
